#!/bin/bash
# G1 arm runner: replay all 17 raw-record logs through
# replay_make_decision_diff with DEFAULT flags (shove-defense + everything
# OFF), seed 42, sample mode. $1 = output dir.
set -u
